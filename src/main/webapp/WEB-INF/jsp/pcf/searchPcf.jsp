...
<div class="row mt">
	<h5 class="sub1_title" data-term="L.PCF_조회"><i class="fa fa-file-text"></i> </h5>
...
<div class="row" style="margin: 0px 15px -25px 0;">	
	<div class="col-md-12 col-sm-12 donut-chart buttonlist" style="text-align: left;">
	    <div class="left">
	        ...
	        <button type="button" class="btn btn-primary" id="urlMngAddRowBtn1" data-term="L.수정"><i class="fa fa-plus"></i> </button>
...
var UrlMng = function () {
    ...
    var model = (function () {
        var URL_SELECT = "/pcf/registerPcf/json";
    ...
    var initGrid = function () {
        $grid.edatagrid({
            ...
            columns: [[	//field 값은 컬럼명 중 _ 있을 경우 대문자로 구분하여 표기
	            ...
	            {
	                field: "accesUrl", title: "URL", formatter: filterXSS, width: "10%"
	            }, 
	            {
	                field: "accesUrl", title: "URL", formatter: filterXSS, width: "10%"
	            }, 
