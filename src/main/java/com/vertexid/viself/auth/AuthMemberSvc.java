/*
 * @(#)AuthMemberSvc.java     2022-02-08(008) 오후 3:36
 *
...
public class AuthMemberSvc extends BaseSvc {
    ...
    private static final String NAMESPACE = "com.vertexid.viself.auth.AuthMember";

    @Resource
    private CmmDAO cmmDAO;

    public String insert(AuthMemberDTO params) {
        String result = "";
        ...
        cmmDAO.insert(cmmDAO.getStmtByNS(NAMESPACE, "insertAuthUser"), params);
    ...
    public String update(AuthMemberDTO params) {
        String result = "";
